...
This document defines a short credits/attribution page for the website. It should acknowledge upstream work clearly without making attribution the main homepage identity.
...
High-performance local speech-to-text engine support for running Whisper-style models on device.
...
Desktop app framework used to combine a Rust backend with a web-based frontend.
...
Rust audio capture library used for native audio recording paths.
...
Rust automation library used for keyboard/cursor output behavior.
...
Use a short attribution in the footer.

Use this full page for:

- open-source acknowledgement
- legal/credits navigation
