...
<svelte:head> <title>Install FFmpeg - SpeakPaste</title> </svelte:head>
										...
										<li class="flex gap-4">
											...
											<div class="space-y-3 flex-1">
												<p class="text-sm text-muted-foreground">
													Restart SpeakPaste, then verify FFmpeg is working:
												</p>
												<Snippet text="ffmpeg -version" variant="secondary" />
											</div>
										</li>
									...
									<div class="space-y-5">
										<div class="p-5 border rounded-lg bg-muted/10 space-y-4">
											...
											>
												...
												<li>
													Restart SpeakPaste completely after adding to PATH
												</li>
												<li>
