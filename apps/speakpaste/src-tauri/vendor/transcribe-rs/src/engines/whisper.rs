...
pub struct WhisperInferenceParams {
    ...
    /// Decode strategy to use for Whisper.
    ///
    /// Beam search is the historical default for this crate. Greedy decoding is
    /// much faster on lower-powered CPUs and is useful for latency-sensitive
    /// dictation.
...
impl Default for WhisperInferenceParams {
    fn default() -> Self {
        Self {
            ...
            no_speech_thold: 0.2,
            initial_prompt: None,
            sampling_strategy: WhisperSamplingStrategy::BeamSearch {
                beam_size: 3,
                patience: -1.0,
            },
        }
...
impl TranscriptionEngine for WhisperEngine {
    ...
    fn transcribe_samples(
        ...
        let mut full_params = FullParams::new(match whisper_params.sampling_strategy {
